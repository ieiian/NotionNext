  ...
  return (
    ...
    >
      ...
      <span className='pl-2 hidden busuanzi_container_site_uv'>
        ...
        <h1>{title}</h1>
        {/* 原始代码 */}
        {/*<span className='text-xs '>Powered by <a href='https://vtse.eu.org' className='underline dark:text-gray-300'>NotionNext {siteConfig('VERSION')}</a>.</span></span><br/> */}
        {/* 修改后的代码 */}
        <span className='text-xs'>Powered by NotionNext</span></span><br/>
